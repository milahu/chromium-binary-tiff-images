...
var create_group4_polyfill_module = (() => {
...
function findWasmBinary() {
  return locateFile('group4-polyfill.wasm');
}
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = create_group4_polyfill_module;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = create_group4_polyfill_module;
} else if (typeof define === 'function' && define['amd'])
  define([], () => create_group4_polyfill_module);
